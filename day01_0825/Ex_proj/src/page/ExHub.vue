...
import Apport_0826 from '../components/ExHub_0826/Apport_0826.vue'
import Vue_0825 from '../components/ExHub_0825/Vue_0825.vue'
...
<template>
  ...
  <div class="layout">
    <aside class="sidebar">
      <nav>
        <button class="nav-btn" :class="{ active: active === 'Vue_0825' }" @click="go('Vue_0825')">
          Vue_0825
        </button>
        <button class="nav-btn" :class="{ active: active === 'Apport_0826' }" @click="go('Apport_0826')">
          Vue_0826
        </button>
      </nav>
    </aside>
...
.nav-btn:hover {
  ...
  border-color: #7b5cff;
  box-shadow: 0 0 0 2px rgba(123, 92, 255, .1);
}

.nav-btn.active {
  border-color: #0c4b04;
  box-shadow: 0 0 0 2px rgba(12, 75, 4, .15);
}
